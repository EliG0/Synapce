<picture>
  <img
    alt="XARXES"
    src="./docs/Images/XARXES-lightv2.png"
  >
</picture>
...
Разработка проекта остановлена на этапе перехода от `CLI` к `JavaFX`. Страница проекта приведена к красивому витринному
виду.

Исходный код CLI-версии (готовность ~75%), а также все наработки, ассеты и архитектурный рефакторинг под `JavaFX`
сохранены и доступны в ветке `javafx-gui`.
...
1. **Hermaeus** - репозиторий для хранения модификаций


2. **Oghma** - менеджер модификаций. Управляет профилями, установкой модов, выстраиванием приоритета и
   динамическим разрешением конфликтов.


3. **Xarxes** - платформа для взаимодействия Oghma & Hermaeus. Отвечает за авторизацию, сессии и
...
*
    * Живое английское (Заркс): В живом английском есть негласное правило: буква **X** в начале слова
