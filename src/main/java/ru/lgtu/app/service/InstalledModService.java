...
import ru.lgtu.app.model.InstalledMod; // Предполагаем, что класс находится здесь
...
public class InstalledModService {
    ...
    public InstalledModService(FileService fileService, ConfigService configService, InputService inputService, ImageService imageService) {
